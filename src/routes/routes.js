...
router.post('/spin/:groupId/:userId', group_controller.performSpin);
 ...
 *         description: Server error
 */
router.delete("/deleteWishlistById/:venueId/:userId", wishlist_controller.deleteWishlistById);
...
router.put("/updateContactList/:userId/:uid", contactController.updateContactList); 
