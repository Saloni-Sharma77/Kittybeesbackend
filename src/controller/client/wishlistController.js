...
exports.getAllWishlist = async (req, res) => {
    try {
      ...
      const wishlists = await WishListModel.find().populate('userId').populate('venueId');
...
exports.getAllWishlistByme = async (req, res) => {
    try {
      ...
      const wishlists = await WishListModel.find({ userId }).populate('userId').populate('venueId');
...
exports.getWishlistById = async (req, res) => {
    try {
      ...
      // Find wishlist by ID
      const wishlist = await WishListModel.findById(wishlistId).populate('userId').populate('venueId');
